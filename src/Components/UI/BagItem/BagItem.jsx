...
class BagItem extends PureComponent {
  ...
  componentDidMount() {
    this.setState({totalSumm:this.context.totalSumm})
  ...
  increaseHandler() {
    ...
    sum+=parseFloat(price)*itemInCart.count;
    console.log(sum)
   
    this.props.increase(sum);
  ...
  render() {
    ...
    return (
      <div className={this.state.count===0?classes.hide:classes.bagContainer}>
        <div className={classes.bagItemInfo}>
